...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6"> <br />
      <h4 align="center"> Add statusmember </h4>
      <hr />
      
      <form  name="addproduct" action="Add_statusmem_DB.php" method="POST" enctype="multipart/form-data"  class="form-horizontal">
        <div class="form-group">
        <div class="col-sm-8">
            <p>statusmember Type:</p>
            <input type="text"  name="item_statusname" class="form-control" required placeholder="statusmember Type" />
          </div>
        </div>
        <br>
        <br>
...
<script>
    ...
    function validateForm() {
        ...
        var name = document.getElementsByName("item_statusname").value;
