...
<html lang="en">
 ...
 if(isset($_POST['username']) && isset($_POST['password'])){
  ...
  $stmt = $conn->prepare("SELECT member_id,member_class, member_name, member_sername,member_status FROM tbl_member WHERE username = :username AND password = :password");
