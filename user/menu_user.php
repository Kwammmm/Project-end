  ...
  <div class="slide-menu">
    ...
    <div class="slide-menu-here">
      ...
      <li><a href="main.php">Home</a></li>
        ...
        <li><a href="report_user.php">Borrowed and returned items</a></li>
...
.slide-header {
  ...
  color: #fff;
  top:0;
  background: url(https://media.discordapp.net/attachments/773568429793083412/1197905355578019870/P_3.png?ex=65bcf74c&is=65aa824c&hm=f3d2369a3e9692c1d99791aa0fdcce8f885da3464845d3df3ec1615e65b0b8db&=&format=webp&quality=lossless)no-repeat center center/cover;
  position: relative;
  text-align: center;
}
